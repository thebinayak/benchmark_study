...
save_dir = os.path.join(os.getcwd(), 'CNN_Sound+Force_MFCC')
...
def model_configure(Sound_data, Force_data):
    ...
    dot_img_file = os.path.join(save_dir, 'CNN_Sound+Force_MFCC.png')
...
def predict(model, X, y):
    ...
    X = X[np.newaxis, ...] # Insert new axis at the beginning to make array shape (1, 130, 132, 1)
