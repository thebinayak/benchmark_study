...
# =============OTHER CONSTANTS =====================
random_states =  [154, 306, 743, 877, 558] #[154] #
test_accuracies = []
history_loss = []
history_accuracy = []
history_val_loss = []
...
# Change two places: line number 50 (for folder name ) and second, line 249(for optimizer)
# ============ CONSTANTS used in the program =====================
save_dir = os.path.join(os.getcwd(), 'MLP_SOUND+FORCE_MelSpectrogram') #RAdam AdamW
...
def model_configure(Sound_data, Force_data):
    ...
    dot_img_file = os.path.join(save_dir, 'MLP_Sound+Force_MelSpectrogram.png')
...
disp.plot()
plt.savefig(os.path.join(save_dir, 'Confusion_Matrix_MLP_S+F_Mel_Spectrogram.png'), dpi=300)
plt.show()
