...
# Change two places: line number 42 (for folder name ) and second, line 63 and line XXX(for optimizer)
# ============ CONSTANTS used in the program =====================
save_dir = os.path.join(os.getcwd(), 'MLP_Audio_only_MFCC')
...
if __name__=="__main__":
    for idx in range(len(random_states)):
      ...
      Sound_train, Sound_validation, Sound_test, Sound_label_train, Sound_label_validation, Sound_label_test = prepare_datasets(
          Sound_inputs, Sound_label, test_size=0.5, validation_size=0.5)
      ...
      model.compile(optimizer=optimizer, loss='categorical_crossentropy',
                    metrics=["accuracy"])
      dot_img_file = os.path.join(save_dir, 'MLP_Sound_Only_MFCC.png')
